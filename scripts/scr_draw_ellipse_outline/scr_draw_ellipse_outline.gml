///@func scr_draw_ellipse_outline(x, y, major_axis, minor_axis, thickness, sector_angle, type, *steps)
///@param x - the x position of the ellipse shell
///@param y - the y position of the ellipse shell
///@param major_axis - the width of the ellipse shell
///@param minor_axis - the height of the ellipse shell
///@param thickness - how thick to make the line
///@param sector_angle - how much of the ellipse to draw (from 0 to 360 degrees)
///@param type - either inside, centered, or outside (0 1 2) respecively
///@param *steps - optional, the amount of steps to draw for the ellipse
